...
namespace Task1JulainReid.Properties
{
    ...
    {
        public RangedUnit(int xPosition, int yPosition, int health, int speed, int attack, int attackRange, string team, string symbol, string name) : base(xPosition, yPosition, health, speed, attack, attackRange, team, symbol, name)
        {
